function H = goodH(t,alpha,mu,Delta,Vz,lambda,N_tot,E_barrier,N_barrier,omega)
...
H = kron(eyesm, (2*t - mu)*tzs0 + Vz*t0sx + SelfE) + kron(barrier,E_barrier*tzs0); % Diagonal Part --- Nanowire
%H = kron(eyesm, (2*t - mu)*tzs0 + Vz*t0sx + Delta*txs0) + kron(barrier,E_barrier*tzs0);
